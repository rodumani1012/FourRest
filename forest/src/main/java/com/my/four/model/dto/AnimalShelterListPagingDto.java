...
public class AnimalShelterListPagingDto {

	final int P = 10; //한블럭에 표시하고싶은 페이지번호수
	//finalt int C
	...
	public AnimalShelterListPagingDto() {
		super();
	}

	public AnimalShelterListPagingDto(int totalcount, int pagenum, int contentnum) {
