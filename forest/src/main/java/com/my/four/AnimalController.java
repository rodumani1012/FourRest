...
public class AnimalController {
	...
	public String ani_shelterlist(String txt_search, String page, Model model) {
		...
		String txt_s = (txt_search == null) ? "" : txt_search;;
		...
		paging.setPageNo(Integer.parseInt(page)); // get방식의 parameter값으로 반은 page변수, 현재 페이지 번호
		paging.setPageSize(10); // 한페이지에 불러낼 게시물의 개수 지정
		paging.setTotalCount(totalCount);
		
		List<AnimalShelterListDto> list = biz.aniSelectList(Integer.parseInt(page), txt_s);
