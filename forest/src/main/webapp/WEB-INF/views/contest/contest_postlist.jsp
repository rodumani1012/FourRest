...
<body>
	...
	<div class="paging">
		<c:if test="${pm.prev }">
			<a
				href="contest_postlist.do?contentnum=6&pagenum=${pm.pagenum-1}&conlistno=${conlistno}">
				<span>◀</span>
			</a>
		</c:if>
		...
		<c:forEach begin="${pag.startPage }" end="${pag.endPage }" var="idx">
			<c:choose>
				...
				<c:otherwise>
					<a href="contest_postlist.do?contentnum=6&pagenum=${idx}&conlistno=${conlistno}"> <span
