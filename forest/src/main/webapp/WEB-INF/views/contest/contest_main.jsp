						...
						<div class="panel-body">
							<div class="pull-right">
								<div class="btn-group">
									...
									<button type="button" class="btn btn-filter" data-target="all">전체</button>
								</div>
							</div>
												...
												<c:choose>
													<c:when test="${today<end&&today>start}">
														<tr data-status="pagado">
															...
															<td>${start }~${end } <a
																style="color: #4cae4c; font-weight: bold;">(진행중)</a>
															</td>
															<td>${dto.partnum }</td>
														</tr>
													</c:when>
			...
			<div class="flexslider left">
				<ul class="slides">
					<c:choose>
						<c:when test="${empty conlist }">
							<li><img
								src="https://source.unsplash.com/BaCmEa2hy8g/1600x900">
								<div class="meta">
									<h1>진행중인 공모전 이없습니다.</h1>
									<h2>공모전을 기다려주세요.</h2>
								</div></li>
							<li><img
								src="https://source.unsplash.com/RmZIUIF2S2Q/1600x900">
								<div class="meta">
									<h1>진행중인 공모전 이없습니다.</h1>
									<h2>공모전을 기다려주세요.</h2>
								</div></li>
							<li><img
								src="https://source.unsplash.com/cFplR9ZGnAk/1600x900">
								<div class="meta">
									<h1>진행중인 공모전 이없습니다.</h1>
									<h2>공모전을 기다려주세요.</h2>
								</div></li>
							<li><img
								src="https://source.unsplash.com/Ui8KQ0ahXBM/1600x900">
								<div class="meta">
									<h1>진행중인 공모전 이없습니다.</h1>
									<h2>공모전을 기다려주세요.</h2>
								</div></li>
						...
						<c:otherwise>
							<c:forEach items="${conlist }" var="dto">
								<li><a href="conlistdetail.do?conlistno=${dto.boardno }">${dto.reppic }</a>
									<div class="meta">
										<h1>${dto.title }</h1>
										<h2>${dto.sort }</h2>
									</div></li>
									...
									<c:forEach items="${threelist }" var="threedto"
										...
										<div class="col-sm-3">
											...
											<div class="text-center">
												<h6 class="card-title">
													순위 : ${status.count } <a
														href="contest_detail.do?boardno=${threedto.boardno }">${threedto.title }
														평점: ${threedto.likerate }</a>
												</h6>
											</div>
										</div>
									</c:forEach>
