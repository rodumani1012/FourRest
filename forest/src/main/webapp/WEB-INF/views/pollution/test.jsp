...
<!-- <script type="text/javascript" src="resources/assets/js/mapjson/map.js"></script> -->
<!-- <head> -->
<!-- <meta charset="UTF-8"> -->
...
//     var data = JSON.stringify(geson.features);
    ...
    $.each(data,function(index,val){
    	console.log(index)
    	console.log(val.properties.CTP_KOR_NM)
     	//name = val.properites.CTP_KOR_NM;
     	//console.log(name);
    	coorditanes = val.geometry.coordinates;
    	console.log(val.geometry.coordinates)
    	sortall(coordinates,name);
    });
    	
    });
    
    function sortall(coordinates,name){
    	var  path = [];
    	var points = [];
