...
VALUES (CALSEQ.NEXTVAL, 'KH청소하기12312', 'admin', '2019-08-02', '2019-08-04', '2019-08-23', '2019-08-25', '같이 청소해요', 20, 0, 'Y', 'Y');

INSERT INTO VOLCALENDAR 
VALUES (CALSEQ.NEXTVAL, 'KH학원청소할까', 'admin', '2019-08-01', '2019-08-05', '2019-08-25', '2019-08-30', '같이 청소해봅시다', 30, 0, 'Y', 'Y');
